...
REPORT_HOME="$TEST_HOME/experiment_results/trace"
source $TEST_HOME/config/default.conf

CHART_NUM=22
declare -a START_RUN=1
declare -a END_RUN=1
declare -a READ_BEHAVIOR_OPTIONS=("regular_change")
declare -a MVC_PROPERTY_OPTIONS=(1 2 3 4 5)
ENABLE_IV_SL_LOG="True"
...
do
    ...
    do
    	...
    	do
    	    STAT_DIR="$REPORT_HOME/MVC$MVC_PROPERTY/RUN$RUN"
    	    mkdir -p $STAT_DIR
    	    rm -f $STAT_DIR/*

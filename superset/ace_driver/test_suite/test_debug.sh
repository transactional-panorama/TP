...
PASSWORD="admin"
DASHBOARD="TPCH"
READ_BEHAVIOR="regular_change" # options: ["not_change", "regular_change", "see_change"]
...
declare -a WRITE_BEHAVIOR_OPTIONS=("filter_change")
declare -a MVC_PROPERTY_OPTIONS=(1 3)
